...
int main() {
       ...
       l = sizeof(client);  // it's an unsigned int!
       ...
       while (1) {
              ...
              int res = recv(c, (char*)&a, sizeof(a), 0);  // RECEIVE NUMBER FROM CLIENT
              ...
              res = send(c, (char*)&suma, sizeof(suma), 0); // SEND NUMBER BACK TO CLIENT
